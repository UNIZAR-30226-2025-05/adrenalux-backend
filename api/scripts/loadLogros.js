...
(async () => {
  try {
    await generarLogros(10, TIPOS_DE_LOGROS.PARTIDAS_JUGADAS, DESCRIPCION_LOGROS.PARTIDAS_JUGADAS, 10, 'XP', RECOMPENSAS.EXPERIENCIA.PERDER_PARTIDA);
    await generarLogros(10, TIPOS_DE_LOGROS.PARTIDAS_GANADAS, DESCRIPCION_LOGROS.PARTIDAS_GANADAS, 5, 'DINERO', RECOMPENSAS.DINERO.GANAR_PARTIDA);
    await generarLogros(11, TIPOS_DE_LOGROS.CARTAS_CONSEGUIDAS,  DESCRIPCION_LOGROS.CARTAS_CONSEGUIDAS, 50, 'XP', RECOMPENSAS.EXPERIENCIA.CARTAS_CONSEGUIDAS);
