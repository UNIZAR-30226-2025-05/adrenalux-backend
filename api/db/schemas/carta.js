...
export const carta = pgTable( 
  {
    id: integer('id')
      .primaryKey()
      .autoincrement(), // Clave primaria y auto-incrementable
    nombre: varchar('nombre', { length: 25 })
      .notNull(),
    equipo: varchar('equipo', { length: 25 })
      .notNull(),
    pais: varchar('pais', { length: 25 })
      .notNull(),
    photo : text('photo')
      .notNull(),
    defensa: integer('defensa')
      .notNull(),
    control: integer('control')
      .notNull(),
    ataque: integer('ataque')
      .notNull(),
 }
);
